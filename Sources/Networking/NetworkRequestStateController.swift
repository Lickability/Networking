...
public final class NetworkRequestStateController: Sendable {
    ...
    @MainActor
    public func send(request: any NetworkRequest, scheduler: some Scheduler = DispatchQueue.main, requestBehaviors: [RequestBehavior] = [], retryCount: Int = 2, flag: Bool = false) {
